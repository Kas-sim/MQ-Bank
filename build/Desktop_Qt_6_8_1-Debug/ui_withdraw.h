...
public:
    ...
    void setupUi(QDialog *withdraw)
    {
        ...
        withdraw->setStyleSheet(QString::fromUtf8("QMainWindow {\n"
"background-color: #000000;\n"
"}\n"
""));
        txtAmountWithdraw = new QLabel(withdraw);
        txtAmountWithdraw->setObjectName("txtAmountWithdraw");
        txtAmountWithdraw->setGeometry(QRect(80, 300, 241, 21));
        QFont font;
        ...
        txtWithdrawTitle->setGeometry(QRect(70, 60, 261, 41));
        QFont font1;
...
"}"));
        ...
        btnArrowBackW->setStyleSheet(QString::fromUtf8("QPushButton {\n"
"background-color: rgba( 255, 255, 255, 0% );\n"
"border: none;\n"
"}"));
        QIcon icon(QIcon::fromTheme(QIcon::ThemeIcon::GoPrevious));
        btnArrowBackW->setIcon(icon);
