...
public:
    ...
    void setupUi(QDialog *deposit)
    {
        ...
        deposit->setStyleSheet(QString::fromUtf8("QDialog{\n"
"background-color: #000000;\n"
"}\n"
""));
        txtDepositTitle = new QLabel(deposit);
        txtDepositTitle->setObjectName("txtDepositTitle");
        txtDepositTitle->setGeometry(QRect(70, 70, 241, 31));
        QFont font;
...
"}"));
        ...
        btnArrowBackD->setCursor(QCursor(Qt::CursorShape::PointingHandCursor));
...
"}"));
        ...
        txtAmountWithdraw->setGeometry(QRect(70, 310, 221, 21));
        QFont font2;
...
"}"));
        ...
        btnSignUp->setGeometry(QRect(140, 410, 71, 21));
        QFont font3;
...
"}"));
    ...
    void retranslateUi(QDialog *deposit)
    {
        ...
        btnArrowBackD->setText(QCoreApplication::translate("deposit", "<-", nullptr));
